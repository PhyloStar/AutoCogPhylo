...
def infomap_concept_evaluate_scores(d, lodict, gop, gep):
    ...
    for concept in d:
        ...
        for k, v in clust.items():
            ...
            #predicted_labels_words[lang_list[k],d[concept][lang_list[k]]] = v
...
data_dict, cogid_dict, words_dict, lang_list = read_data_ielex_type(dataname)
